...
class HTTPServer(Server):
    ...
    def login(self, params):
        ...
        soliskey = unquote(params.get(b"soliskey", None))
        solissecret = unquote(params.get(b"solissecret", None))
        solisid = unquote(params.get(b"solisid", None))
        solissn = unquote(params.get(b"solissn", None))
        print(
            f"I got as far as the parameters - {ssid} {password} {soliskey} {solissecret} {solisid} {solissn}"
        )
